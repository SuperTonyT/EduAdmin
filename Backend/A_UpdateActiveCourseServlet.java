...
@WebServlet(name = "A_UpdateActiveCourseServlet", urlPatterns = "/A_UpdateActiveCourseServlet")
public class A_UpdateActiveCourseServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try{
            pstmt=ct.prepareStatement("update ActiveCourse set 上课时间=? where 学期=? and 课号=? and 工号=?");
