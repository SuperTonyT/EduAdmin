...
@WebServlet(name = "A_AddTeacherServlet", urlPatterns = "/A_AddTeacherServlet")
public class A_AddTeacherServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try{
            ...
            pstmt.setInt(6, Integer.parseInt(request.getParameter("salary")));
